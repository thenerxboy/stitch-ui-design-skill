...
`stitch-ui-design-skill` is a universal, agent-agnostic UI design system framework. It provides:
...
1. **Clone the Skill into your Project**:
   ```bash
   git clone https://github.com/thenerxboy/stitch-ui-design-skill.git .agents/skills/ui-design-skill
   ```

2. **Instruct ANY AI Agent (Claude Code, Cursor, Antigravity, ChatGPT)**:
   > *"Read `SKILL.md` inside `.agents/skills/ui-design-skill/` and bootstrap this app project workspace."*
